...
My research is based exclusively on linear regression. Other methods, such as Support Vector Machines or Random Forrest, may be able to achieve much better results. This data set provides a rich opportunity for research, and it would be beneficial to try other methods for comparison purposes.
...
![](https://raw.githubusercontent.com/omerozeren/DATA621/master/final_project/fig1_na_dist.png)
\begin{center}
Figure 2. Missing values.
\end{center}

![](https://raw.githubusercontent.com/omerozeren/DATA621/master/final_project/fig2_imputation.png)
\begin{center}
Figure 3. Density plots of observed (blue) and imputed (red) values.
\end{center}

![](https://raw.githubusercontent.com/omerozeren/DATA621/master/final_project/fig3_boxplots.png)
\begin{center}
...
# Read data
url_train <- paste0("https://raw.githubusercontent.com/omerozeren/DATA621/master/final_project/train.csv")
url_test <-  paste0("https://raw.githubusercontent.com/omerozeren/DATA621/master/final_project/test.csv")
...
LotShape_ <- c("Reg", "IR1", "IR2", "IR3")       
Utilities_ <- c("AllPub", "NoSeWa")              
LandSlope_ <- c("Gtl","Mod", "Sev")             
ExterQual_ <- c("Ex", "Gd", "TA", "Fa")           
ExterCond_ <- c("Ex", "Gd", "TA", "Fa", "Po")     
BsmtQual_ <- c("Ex", "Gd", "TA", "Fa", "NoB")     
BsmtCond_ <- c("Gd", "TA", "Fa", "NoB")           
BsmtExposure_ <- c("Gd", "Av", "Mn", "No", "NoB") 
BsmtFinType1_ <- c("GLQ", "ALQ", "BLQ", 
                   "Rec", "LwQ", "Unf", "NoB")    
BsmtFinType2_ <- c("GLQ", "ALQ", "BLQ", 
                   "Rec", "LwQ", "Unf", "NoB")    
HeatingQC_ <- c("Ex", "Gd", "TA", "Fa", "Po")    
Electrical_ <- c("SBrkr", "FuseA", "FuseF",
                 "FuseP", "Mix")                  
KitchenQual_ <- c("Ex", "Gd", "TA", "Fa")        
Functional_ <- c("Typ", "Min1", "Min2", "Mod",
                 "Maj1", "Maj2", "Sev")           
FireplaceQu_ <- c("Ex", "Gd", "TA", "Fa", 
                  "Po", "NoFp")                   
GarageFinish_ <- c("Fin", "RFn", "Unf", "NoG")    
GarageQual_ <- c("Ex", "Gd", "TA", "Fa", "Po", 
                 "NoG")                          
GarageCond_ <- c("Ex", "Gd", "TA", "Fa", "Po", 
                 "NoG")                           
PavedDrive_ <- c("Y", "P", "N")                   
PoolQC_ <- c("Ex", "Gd", "Fa", "NoP")             
...
# Read prepared data
bcData = read.csv(paste0('https://raw.githubusercontent.com/omerozeren/DATA621/master/final_project/train_BC_transformed.csv'))
bcData$X = NULL
imputedData = read.csv(paste0('https://raw.githubusercontent.com/omerozeren/DATA621/master/final_project/train_orig_vars_imputed.csv'))
imputedData$X = NULL
transformedData = read.csv(paste0('https://raw.githubusercontent.com/omerozeren/DATA621/master/final_project/train_predictors_transformed.csv'))
...
summary(m6TD)
# Read test data
transformedTest = read.csv(paste0('https://raw.githubusercontent.com/omerozeren/DATA621/master/final_project/test_predictors_transformed.csv'))
